...
void TransformBabyGohma_SetupAction(TransformBabyGohma* this, PlayState* play,
...
void TransformBabyGohma_Action_Jump(TransformBabyGohma* this, PlayState* play) {
    ...
    if (this->actor.velocity.y <= 0.0f &&
        ((this->actor.bgCheckFlags & BGCHECKFLAG_GROUND) || (this->actor.bgCheckFlags & BGCHECKFLAG_WATER))) {
