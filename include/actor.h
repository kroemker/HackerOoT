...
typedef struct Actor {
    ...
    /* 0x01E */ s8
        objectSlot; // Object slot (in ObjectContextLegacy) corresponding to the actor's object; original name: "bank"
    /* 0x01F */ s8
...
// HackerOoT: helpers for player transformation actors
s32 Actor_IsTransformActor(s16 actorId);
void* Actor_GetObjectSegment(struct PlayState* play, Actor* actor);
void Actor_HandleZTarget(Actor* actor, struct PlayState* play);
